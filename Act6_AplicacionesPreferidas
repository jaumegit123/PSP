# Actividad 6. Aplicaciones Preferidas.
Pequeña barra de tareas con nuestras 4 aplicaciones preferidas mediante Swing y ProcessBuilder.

## Clase AplicacionesPreferidas
```java
